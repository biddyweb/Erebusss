...
enum TestID {
    ...
    TEST_MEMORYQUEST_0 = 48,
    TEST_MEMORYQUEST_1 = 49,
    TEST_MEMORYQUEST_2 = 50,
    TEST_MEMORYQUEST_3 = 51,
    TEST_LOADSAVE_QUEST_1_COMPLETED = 52,
    TEST_LOADSAVE_ACTION_LAST_TIME_BUG = 53,
    TEST_LOADSAVEWRITEQUEST_0_COMPLETE = 54,
    TEST_LOADSAVEWRITEQUEST_0_WARRIOR = 55,
    TEST_LOADSAVEWRITEQUEST_0_BARBARIAN = 56,
    TEST_LOADSAVEWRITEQUEST_0_ELF = 57,
    TEST_LOADSAVEWRITEQUEST_0_RANGER = 58,
    TEST_LOADSAVEWRITEQUEST_1_COMPLETE = 59,
    TEST_LOADSAVEWRITEQUEST_1_NPC_CALBERT = 60,
    TEST_LOADSAVEWRITEQUEST_1_NPC_GHOST = 61,
    TEST_LOADSAVEWRITEQUEST_1_ELF = 62,
    TEST_LOADSAVEWRITEQUEST_1_RANGER = 63,
    TEST_LOADSAVEWRITEQUEST_1_HALFLING = 64,
    TEST_LOADSAVEWRITEQUEST_1_REVEAL = 65,
    TEST_LOADSAVEWRITEQUEST_1_ITEMS = 66,
    TEST_LOADSAVEWRITEQUEST_2_COMPLETE = 67,
    TEST_LOADSAVEWRITEQUEST_2_NPC_ANMARETH = 68,
    TEST_LOADSAVEWRITEQUEST_2_NPC_GLENTHOR = 69,
    TEST_LOADSAVEWRITEQUEST_2_ITEMS = 70,
    N_TESTS = 71
};
