...
enum TestID {
    ...
    TEST_USE_AMMO = 43,
    TEST_LOADSAVEQUEST_0 = 44,
    TEST_LOADSAVEQUEST_1 = 45,
    TEST_LOADSAVEQUEST_2 = 46,
    TEST_LOADSAVEQUEST_3 = 47,
    TEST_LOADSAVERANDOMQUEST_0 = 48,
    TEST_MEMORYQUEST_0 = 49,
    TEST_MEMORYQUEST_1 = 50,
    TEST_MEMORYQUEST_2 = 51,
    TEST_MEMORYQUEST_3 = 52,
    TEST_LOADSAVE_QUEST_1_COMPLETED = 53,
    TEST_LOADSAVE_ACTION_LAST_TIME_BUG = 54,
    TEST_LOADSAVEWRITEQUEST_0_COMPLETE = 55,
    TEST_LOADSAVEWRITEQUEST_0_WARRIOR = 56,
    TEST_LOADSAVEWRITEQUEST_0_BARBARIAN = 57,
    TEST_LOADSAVEWRITEQUEST_0_ELF = 58,
    TEST_LOADSAVEWRITEQUEST_0_RANGER = 59,
    TEST_LOADSAVEWRITEQUEST_1_COMPLETE = 60,
    TEST_LOADSAVEWRITEQUEST_1_NPC_CALBERT = 61,
    TEST_LOADSAVEWRITEQUEST_1_NPC_GHOST = 62,
    TEST_LOADSAVEWRITEQUEST_1_ELF = 63,
    TEST_LOADSAVEWRITEQUEST_1_RANGER = 64,
    TEST_LOADSAVEWRITEQUEST_1_HALFLING = 65,
    TEST_LOADSAVEWRITEQUEST_1_REVEAL = 66,
    TEST_LOADSAVEWRITEQUEST_1_ITEMS = 67,
    TEST_LOADSAVEWRITEQUEST_2_COMPLETE = 68,
    TEST_LOADSAVEWRITEQUEST_2_NPC_ANMARETH = 69,
    TEST_LOADSAVEWRITEQUEST_2_NPC_GLENTHOR = 70,
    TEST_LOADSAVEWRITEQUEST_2_ITEMS = 71,
    N_TESTS = 72
};
