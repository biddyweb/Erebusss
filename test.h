...
enum TestID {
    ...
    TEST_LOADSAVERANDOMQUEST_1 = 50,
    TEST_LOADSAVERANDOMQUEST_2 = 51,
    TEST_LOADSAVERANDOMQUEST_3 = 52,
    TEST_LOADSAVERANDOMQUEST_4 = 53,
    TEST_LOADSAVERANDOMQUEST_5 = 54,
    TEST_LOADSAVERANDOMQUEST_6 = 55,
    TEST_MEMORYQUEST_0 = 56,
    TEST_MEMORYQUEST_1 = 57,
    TEST_MEMORYQUEST_2 = 58,
    TEST_MEMORYQUEST_3 = 59,
    TEST_LOADSAVE_QUEST_1_COMPLETED = 60,
    TEST_LOADSAVE_ACTION_LAST_TIME_BUG = 61,
    TEST_LOADSAVEWRITEQUEST_0_COMPLETE = 62,
    TEST_LOADSAVEWRITEQUEST_0_WARRIOR = 63,
    TEST_LOADSAVEWRITEQUEST_0_BARBARIAN = 64,
    TEST_LOADSAVEWRITEQUEST_0_ELF = 65,
    TEST_LOADSAVEWRITEQUEST_0_RANGER = 66,
    TEST_LOADSAVEWRITEQUEST_1_COMPLETE = 67,
    TEST_LOADSAVEWRITEQUEST_1_NPC_CALBERT = 68,
    TEST_LOADSAVEWRITEQUEST_1_NPC_GHOST = 69,
    TEST_LOADSAVEWRITEQUEST_1_ELF = 70,
    TEST_LOADSAVEWRITEQUEST_1_RANGER = 71,
    TEST_LOADSAVEWRITEQUEST_1_HALFLING = 72,
    TEST_LOADSAVEWRITEQUEST_1_REVEAL = 73,
    TEST_LOADSAVEWRITEQUEST_1_ITEMS = 74,
    TEST_LOADSAVEWRITEQUEST_2_COMPLETE = 75,
    TEST_LOADSAVEWRITEQUEST_2_NPC_ANMARETH = 76,
    TEST_LOADSAVEWRITEQUEST_2_NPC_GLENTHOR = 77,
    TEST_LOADSAVEWRITEQUEST_2_ITEMS = 78,
    TEST_LOADSAVEWRITEQUEST_2_FIRE_ANT_0 = 79,
    TEST_LOADSAVEWRITEQUEST_2_FIRE_ANT_1 = 80,
    TEST_LOADSAVEWRITEQUEST_2_FIRE_ANT_2 = 81,
    N_TESTS = 82
};
