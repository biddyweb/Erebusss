...
enum TestID {
    ...
    TEST_LOADSAVEWRITEQUEST_0_HATRED = 52,
    TEST_LOADSAVEWRITEQUEST_1_COMPLETE = 53,
    TEST_LOADSAVEWRITEQUEST_1_NPC_CALBERT = 54,
    TEST_LOADSAVEWRITEQUEST_1_NPC_GHOST = 55,
    TEST_LOADSAVEWRITEQUEST_1_ELF = 56,
    TEST_LOADSAVEWRITEQUEST_1_RANGER = 57,
    TEST_LOADSAVEWRITEQUEST_1_REVEAL = 58,
    TEST_LOADSAVEWRITEQUEST_2_COMPLETE = 59,
    TEST_LOADSAVEWRITEQUEST_2_NPC_ANMARETH = 60,
    TEST_LOADSAVEWRITEQUEST_2_NPC_GLENTHOR = 61,
    N_TESTS = 61
};
