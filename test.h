...
enum TestID {
    ...
    TEST_LOADSAVEWRITEQUEST_1_REVEAL = 59,
    TEST_LOADSAVEWRITEQUEST_2_COMPLETE = 60,
    TEST_LOADSAVEWRITEQUEST_2_NPC_ANMARETH = 61,
    TEST_LOADSAVEWRITEQUEST_2_NPC_GLENTHOR = 62,
    N_TESTS = 63
};
